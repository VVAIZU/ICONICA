...
export default function NavBar() {
    ...
    return (
        //flex gap-1 mb-4 mr-3
        <div className="text-white p-4 pr-0">
            ...
            <nav className="flex flex-col gap-2">
                ...
                {user.role === 'admin' && (
                    <Link href={'/adminPanel'} className={pathname.includes('/adminPanel') ? activeLink : inactiveLink}>
                ...
                <Link href={'/login'} className={pathname.includes('/login') ? activeLink : inactiveLink}>
                    {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
